...
class LikeDbHelper {
  ...
  Future<Database?> inttDB() async {
    ...
    db = await openDatabase(Dbparth, version: 1, onCreate: (Database db, version) async {
      String query = "CREATE TABLE IF NOT EXISTS $table(id INTEGER PRIMARY KEY AUTOINCREMENT,quote TEXT,image BLOB);";
