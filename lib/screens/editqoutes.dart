...
class Quotesview extends StatefulWidget {
  Quotesview({Key? key, required this.quotes, required this.image, required this.index}) : super(key: key);
  String quotes;
  String image;
  int index;
    ...
    return Scaffold(
      body: Stack(alignment: Alignment.center, children: [
        Container(
          ...
          decoration: BoxDecoration(image: DecorationImage(image: NetworkImage(widget.image), fit: BoxFit.cover), color: Colors.black38),
          child: Center(
