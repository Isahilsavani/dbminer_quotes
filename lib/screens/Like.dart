...
// import 'package:dbminer_quotes/screens/homescreenList.dart';
                            ...
                            child: Column(
                              children: [
                                Container(
                                  height: 380,
                                  decoration: BoxDecoration(
                                      image: DecorationImage(image: NetworkImage("${Alllike?[i].image}"), fit: BoxFit.cover),
                                ...
                                Row(
                                  ...
                                  children: [
                                    InkWell(
                                      onTap: () {
                                        setState(() {
                                          Alllike?[i].image = Alllike[Counter].image;
                                          if (Counter < 40) {
                                            Counter++;
                                          }
                                        });
                                      },
                                      child: Image(image: AssetImage("assets/image/chang.jpg"), height: 30),
                                    ),
